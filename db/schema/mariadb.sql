CREATE TABLE assessment_records (
    ...
    audit_record_json LONGTEXT NOT NULL,
    INDEX ix_assessment_records_created_at (created_at),
    INDEX ix_assessment_records_jurisdiction (jurisdiction),
    INDEX ix_assessment_records_profile_name (profile_name),
    INDEX ix_assessment_records_recommendation_tier (recommendation_tier)
);
